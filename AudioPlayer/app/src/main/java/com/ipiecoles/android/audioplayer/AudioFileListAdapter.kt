...
class AudioFileListAdapter(private val lifecycleOwner: LifecycleOwner):
    ListAdapter<AudioFile, AudioFileListAdapter.ViewHolder>(AudioFile.DIFF_CB){
    ...
    inner class ViewHolder(
        ...
        val viewModel = MutableLiveData<AudioFile>()
        init {
